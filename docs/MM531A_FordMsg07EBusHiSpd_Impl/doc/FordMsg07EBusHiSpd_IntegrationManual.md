---
layout: default
title: FordMsg07EBusHiSpd_IntegrationManual
nav_order: 1
...
|----------|----------------------------------------------|-----------------|
| **Sr. No.** | **Title**                             | **Version**                     |
| 1           | FDD: MM531A_FordMsg07EBusHiSpd_Design | See Synergy Sub Project Version |
...
| **FordMsg07EBusHiSpdInit1** | None                        | RTE (Init)  |

|                            |                             |             |
|----------------------------|-----------------------------|-------------|
| **Runnable**               | **Scheduling Requirements** | **Trigger** |
| **FordMsg07EBusHiSpdPer1** | None                        | RTE (10 ms) |
